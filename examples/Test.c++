...
const std::ptrdiff_t r =  5;
const std::ptrdiff_t c = 10;
const std::ptrdiff_t s = r * c;
...
//  const int*      p = a;                            // doesn't compile
    ...
    assert(sizeof(p) == 8);
//  f1(p);                                            // doesn't compile
//  f2(p);                                            // doesn't compile
    g1(p);
    assert(a[2][3] == v + 2);
    g2(p);
    assert(a[2][3] == v + 4);
...
//  const pointer2d q = a[0];                         // doesn't compile
    ...
    f2(q);
    assert(a[2][3] == v + 8);
//  g1(q);                                            // doesn't compile
//  g2(q);                                            // doesn't compile
